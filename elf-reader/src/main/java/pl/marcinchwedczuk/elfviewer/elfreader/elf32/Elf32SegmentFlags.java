...
public class Elf32SegmentFlags extends BitFlags<Elf32SegmentFlags> {
    ...
    @ElfApi("PF_W")
    public static final Flag<Elf32SegmentFlags> Writable = flag("W", 1 << 1);

    @ElfApi("PF_R")
    public static final Flag<Elf32SegmentFlags> Readable = flag("R", 1 << 2);

    @ElfApi("PF_MASKOS")
    public static final Mask<Elf32SegmentFlags> OsSpecificMask = mask(0x0ff00000);

    @ElfApi("PF_MASKPROC")
    public static final Mask<Elf32SegmentFlags> ProcessorSpecificMask = mask(0xf0000000);
